...
public class GroupChannelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void load() {
        try {
            ...
            File dataFile = new File(appDir, com.almurray.android.almurrayportal.utils.TextUtils.generateMD5(SendBird.getCurrentUser().getUserId() + "channel_list") + ".data");
    ...
    public void save() {
        try {
            ...
            if (mChannelList != null && mChannelList.size() > 0) {
                ...
                String md5 = com.almurray.android.almurrayportal.utils.TextUtils.generateMD5(data);

                // Save the data into file.
                File appDir = new File(mContext.getCacheDir(), SendBird.getApplicationId());
                appDir.mkdirs();

                File hashFile = new File(appDir, com.almurray.android.almurrayportal.utils.TextUtils.generateMD5(SendBird.getCurrentUser().getUserId() + "channel_list") + ".hash");
                File dataFile = new File(appDir, com.almurray.android.almurrayportal.utils.TextUtils.generateMD5(SendBird.getCurrentUser().getUserId() + "channel_list") + ".data");
